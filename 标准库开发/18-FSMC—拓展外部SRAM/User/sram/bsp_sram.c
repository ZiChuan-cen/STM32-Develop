...
void FSMC_GPIO_Config(void)
{
	...
	RCC_AHB1PeriphClockCmd(FSMC_A0_GPIO_CLK | FSMC_A1_GPIO_CLK | FSMC_A2_GPIO_CLK | 
                         ...
                         /*数据信号线*/
                           ...
                           FSMC_UDQM_GPIO_CLK|FSMC_LDQM_GPIO_CLK, 
...
void FSMC_Config(void)
{
	...
	//	一个HCLK周期长度为 1/168 微秒 = 6ns
	FSMC_NORSRAMTimingStruct.FSMC_AddressSetupTime  =  0;		// (0+1)个HCLK周期等于 6
	FSMC_NORSRAMTimingStruct.FSMC_DataSetupTime  =  8;  //(8+1)个HCLK周期等于 54
